...
namespace Python.Python.Winform
{
    public class MenuManager
    {
        ...
        {
            iDEManager.CurrentFile.FoldAll(FoldAction.Contract);
        }

        public void expandAllToolStripMenuItem_Click(object sender, EventArgs e)
        {
            iDEManager.CurrentFile.FoldAll(FoldAction.Expand);
        }
        ...
        public void Lowercase()
        {
            ...
            // save the selection
            int start = iDEManager.CurrentFile.SelectionStart;
            int end = iDEManager.CurrentFile.SelectionEnd;

            // modify the selected text
            iDEManager.CurrentFile.ReplaceSelection(iDEManager.CurrentFile.GetTextRange(start, end - start).ToLower());

            // preserve the original selection
            iDEManager.CurrentFile.SetSelection(start, end);
        }
        ...
        public void Uppercase()
        {
            ...
            // modify the selected text
            iDEManager.CurrentFile.ReplaceSelection(iDEManager.CurrentFile.GetTextRange(start, end - start).ToUpper());
        ...
        public void ZoomIn()
        {
            iDEManager.CurrentFile.ZoomIn();
        }

        public void ZoomOut()
        {
            iDEManager.CurrentFile.ZoomOut();
        }

        public void ZoomDefault()
        {
            iDEManager.CurrentFile.Zoom = 0;
        }
        ...
        {
            SearchManager.Find(iDEManager.CurrentFile, searchtext, false, false);
        }
        public void BtnNextSearch_Click(object sender, EventArgs e)
        {
            SearchManager.Find(iDEManager.CurrentFile, searchtext, true, false);
        }
        public void TxtSearch_TextChanged(object sender, EventArgs e)
        {
            SearchManager.Find(iDEManager.CurrentFile, searchtext, true, true);
        }
        ...
        {
            if (iDEManager.CurrentFile.InvokeRequired)
            {
                iDEManager.CurrentFile.BeginInvoke(action);
            }
            else
            {
                action.Invoke();
