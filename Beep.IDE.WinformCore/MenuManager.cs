...
namespace Beep.IDE
{
    public class MenuManager
    {
        ...
        List<ToolStripItem> packages=new List<ToolStripItem>();
        ...
        public MenuManager(IDEManager piDEManager)
        {
            iDEManager = piDEManager;
        ...
        public void CreateMenu(MenuStrip pmenuStrip)
        {
        ...
        public void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
               ...
               //iDEManager.LoadScriptFile(null);
        ...
        {
            iDEManager.CurrentFile.EditorControl.Cut();
        }

        public void copyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            iDEManager.CurrentFile.EditorControl.Copy();
        }

        public void pasteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            iDEManager.CurrentFile.EditorControl.Paste();
        }

        public void selectAllToolStripMenuItem_Click(object sender, EventArgs e)
        {
            iDEManager.CurrentFile.EditorControl.SelectAll();
        }

        public void selectLineToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Line line = iDEManager.CurrentFile.EditorControl.Lines[iDEManager.CurrentFile.EditorControl.CurrentLine];
            iDEManager.CurrentFile.EditorControl.SetSelection(line.Position + line.Length, line.Position);
        }

        public void clearSelectionToolStripMenuItem_Click(object sender, EventArgs e)
        {
            iDEManager.CurrentFile.EditorControl.SetEmptySelection(0);
        }
        ...
        public void wordWrapToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            //  iDEManager.CurrentFile.WrapMode = wordWrapItem.Checked ? WrapMode.Word : WrapMode.None;
        }
        ...
        public void indentGuidesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            // iDEManager.CurrentFile.IndentationGuides = indentGuidesItem.Checked ? IndentView.LookBoth : IndentView.None;
        }
        ...
        public void hiddenCharactersToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //  iDEManager.CurrentFile.ViewWhitespace = hiddenCharactersItem.Checked ? WhitespaceMode.VisibleAlways : WhitespaceMode.Invisible;
        }
        ...
        {
            iDEManager.CurrentFile.EditorControl.FoldAll(FoldAction.Contract);
        }

        public void expandAllToolStripMenuItem_Click(object sender, EventArgs e)
        {
            iDEManager.CurrentFile.EditorControl.FoldAll(FoldAction.Expand);
        }
        ...
        public void Lowercase()
        {
            ...
            // save the selection
            int start = iDEManager.CurrentFile.EditorControl.SelectionStart;
            int end = iDEManager.CurrentFile.EditorControl.SelectionEnd;

            // modify the selected text
            iDEManager.CurrentFile.EditorControl.ReplaceSelection(iDEManager.CurrentFile.EditorControl.GetTextRange(start, end - start).ToLower());

            // preserve the original selection
            iDEManager.CurrentFile.EditorControl.SetSelection(start, end);
        }
        ...
        public void Uppercase()
        {
            ...
            // modify the selected text
            iDEManager.CurrentFile.EditorControl.ReplaceSelection(iDEManager.CurrentFile.EditorControl.GetTextRange(start, end - start).ToUpper());
        ...
        public void GenerateKeystrokes(string keys)
        {
            ...
            iDEManager.CurrentFile.EditorControl.Focus();
            SendKeys.Send(keys);
        ...
        public void ZoomIn()
        {
            iDEManager.CurrentFile.EditorControl.ZoomIn();
        }

        public void ZoomOut()
        {
            iDEManager.CurrentFile.EditorControl.ZoomOut();
        }

        public void ZoomDefault()
        {
            iDEManager.CurrentFile.EditorControl.Zoom = 0;
        }
        ...
        public void OpenSearch()
        {
            ...
            //iDEManager.SearchManager.f iDEManager.CurrentFile;
        ...
        {
            SearchManager.Find(iDEManager.CurrentFile.EditorControl, searchtext,false, false);
        }
        public void BtnNextSearch_Click(object sender, EventArgs e)
        {
            SearchManager.Find(iDEManager.CurrentFile.EditorControl, searchtext, true, false);
        }
        public void TxtSearch_TextChanged(object sender, EventArgs e)
        {
            SearchManager.Find(iDEManager.CurrentFile.EditorControl, searchtext, true, true);
        }
        ...
        {
            if (iDEManager.CurrentFile.EditorControl.InvokeRequired)
            {
                iDEManager.CurrentFile.EditorControl.BeginInvoke(action);
            }
            else
            {
                action.Invoke();
